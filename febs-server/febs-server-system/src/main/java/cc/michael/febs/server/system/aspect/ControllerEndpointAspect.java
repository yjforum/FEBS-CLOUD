package cc.michael.febs.server.system.aspect;
...
import cc.michael.febs.server.system.service.ILogService;
...
public class ControllerEndpointAspect extends BaseAspectSupport {
    ...
    @Pointcut("execution(* cc.michael.febs.server.system.controller.*.*(..)) && @annotation(cc.michael.febs.server.system.annotation.ControllerEndpoint)")
