package cc.michael.febs.gateway.enhance.configure;

import cc.michael.febs.common.core.entity.constant.FebsConstant;
import cc.michael.febs.gateway.enhance.runner.FebsRouteEnhanceRunner;
...
@EnableAsync
@Configuration
@EnableReactiveMongoRepositories(basePackages = "cc.michael.febs.gateway.enhance.mapper")
